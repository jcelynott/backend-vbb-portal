    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reading_level', models.IntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('announcements_group', models.CharField(blank=True, max_length=254, null=True)),
                ('collaboration_group', models.CharField(blank=True, max_length=254, null=True)),
                ('village_info_link', models.CharField(blank=True, max_length=200, null=True)),
                ('default_language', models.CharField(choices=[('ENGLISH', 'ENGLISH')], max_length=254)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('computer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='sessionslots', to='program.Computer')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('external_id', models.UUIDField(db_index=True, default=uuid.uuid4, unique=True)),
                ('name', models.CharField(blank=True, max_length=40, null=True)),
                ('school', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='program.School')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='program.Book')),
        ...
        migrations.AddField(
            model_name='book',
            name='library',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='program.Library'),
        ),
    ]
